...
public class Avancado extends Jogador {
    ...
    private final double pResistencia = 0.10;
    private final double pDestreza = 0.10;
    private final double pImpulsao = 0.15;
    private final double pJogoDeCabeca = 0.18;
    private final double pRemate = 0.20;
